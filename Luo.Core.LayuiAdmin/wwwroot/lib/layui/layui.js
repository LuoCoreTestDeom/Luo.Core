    ...
    r.digit = function (t, e, n) {
        ...
        r.position = function (e, o, i) {
            if (o) {
                ...
                "center" === i.align ? h -= (u - e.offsetWidth) / 2 : "right" === i.align && (h = h - u + e.offsetWidth),
                    ...
                    h < f && (h = f),
                    p + a + f > l() && (c.top > a + f ? p = c.top - a - 2 * f : "right" === i.clickType && (p = l() - a - 2 * f,
                        p < 0 && (p = 0)));
                var y = i.position;
                if (y && (o.style.position = y),
                    ...
                    !i.SYSTEM_RELOAD && d.bottom + f > l() && (i.SYSTEM_RELOAD = !0,
                        setTimeout(function () {
                            r.position(e, o, i)
                        }, 50))
                }
        ...
        o.prototype.insertVal = function (t) {
            ...
            return t ? e.each(function (e, n) {
                ...
                if ("number" != typeof n.selectionStart || i)
                    n.value = "",
                        n.focus(),
                        n.value = o + t;
                else {
                    ...
                    n.value = a.join(""),
                        n.focus(),
                        n.selectionStart = c + t.length,
                        n.selectionEnd = c + t.length
                }
            }) : e
        }
        ,
        o.prototype.deleteVal = function () {
            ...
            return t.each(function (t, e) {
                ...
                if ("number" != typeof e.selectionStart || o)
                    e.value = "",
                        e.focus(),
                        e.value = n.replace(/[\s\S]{1}$/, "");
                else {
    ...
    u.prototype.type = function () {
            ...
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1
                , r = {
                    ...
                    page: function () {
                        ...
                        for (u - i < t - 1 && (i = u - t + 1),
                            a.first !== !1 && i > 2 && e.push('<span class="layui-laypage-spr">&#x2026;</span>'); i <= u; i++)
                            i === a.curr ? e.push('<span class="layui-laypage-curr"><em class="layui-laypage-em" ' + (/^#/.test(a.theme) ? 'style="background-color:' + a.theme + ';"' : "") + "></em><em>" + ("function" == typeof a.parse.curr ? a.parse.curr(i, a) : i) + "</em></span>") : e.push('<a href="javascript:;" data-page="' + i + '">' + i + "</a>");
        ...
        u.prototype.jump = function (e, a) {
            if (e) {
                ...
                if (a)
                    return c();
                for (var o = 0, y = i.length; o < y; o++)
                    "a" === i[o].nodeName.toLowerCase() && s.on(i[o], "click", function () {
                        var e = 0 | this.getAttribute("data-page");
                        e < 1 || e > r.pages || (r.curr = e,
                            t.render())
                    });
                p && s.on(p, "change", function () {
                    var e = this.value;
                    r.curr * e > r.count && (r.curr = Math.ceil(r.count / e)),
                        r.limit = e,
                        t.render()
                }),
        ...
        u.prototype.skip = function (e) {
            if (e) {
                ...
                t && s.on(t, "keyup", function (t) {
                    var n = this.value
                        , r = t.keyCode;
                    /^(37|38|39|40)$/.test(r) || (/\D/.test(n) && (this.value = n.replace(/\D/, "")),
                        13 === r && a.jump(e, !0))
                })
            }
        }
        ...
        u.prototype.render = function (e) {
            var n = this
                ...
                , s = null;
            2 === i ? (s = r.elem,
                r.elem && (s.innerHTML = u)) : 3 === i ? (s = r.elem[0],
                    r.elem.html(u)) : a[t](r.elem) && (s = a[t](r.elem),
                        s.innerHTML = u),
                r.jump && r.jump(r, e);
            var l = s && s.querySelector(".layui-laypage");
            l = l || a[t]("layui-laypage-" + r.index),
                n.jump(l),
                r.hash && !e && (location.hash = "!" + r.hash + "=" + r.curr),
                n.skip(l)
        }
        ;
    var s = {
    ...
    r.formatArr = function (e) {
                ...
                a.elem[0] && (t.rangeStr = a.range ? "string" == typeof a.range ? a.range : "-" : "",
                    ...
                    lay.each(["min", "max"], function (e, t) {
                        ...
                        if ("number" == typeof a[t]) {
                            ...
                            n = [o.getFullYear(), o.getMonth() + 1, o.getDate()],
                                l < s || (i = [o.getHours(), o.getMinutes(), o.getSeconds()])
                        } else
        ...
        C.prototype.render = function () {
            ...
            if (a.zIndex && (r.style.zIndex = a.zIndex),
                ...
                lay(m).html(function () {
                    var e = []
                        , t = [];
                    return "datetime" === a.type && e.push('<span lay-type="datetime" class="' + x + '">' + n.timeTips + "</span>"),
        ...
        C.prototype.checkDate = function (e) {
            var t, a, n = this, i = (new Date,
                n.config), r = n.lang(), s = i.dateTime = i.dateTime || n.systemDate(), o = n.bindElem || i.elem[0], y = (n.isInput(o) ? "val" : "html",
                    function () {
                        if (n.rangeElem) {
                        ...
                        return e ? (e.year > m[1] && (e.year = m[1],
                            a = !0),
                        ...
                        t = (t.match(n.EXP_SPLIT) || []).slice(1),
                            l = l || 0,
                            i.range && (n[r[l]] = n[r[l]] || {}),
                            lay.each(n.format, function (s, o) {
                                var y = parseFloat(t[s]);
                                t[s].length < o.length && (a = !0),
                                    /yyyy|y/.test(o) ? (y < m[0] && (y = m[0],
                                        a = !0),
                                        e.year = y) : /MM|M/.test(o) ? (y < 1 && (y = 1,
                                            a = !0),
                                            e.month = y - 1) : /dd|d/.test(o) ? (y < 1 && (y = 1,
                                                a = !0),
                                                e.date = y) : /HH|H/.test(o) ? (y < 1 && (y = 0,
                                                    a = !0),
                                                    e.hours = y,
                                                    i.range && (n[r[l]].hours = y)) : /mm|m/.test(o) ? (y < 1 && (y = 0,
                                                        a = !0),
                                                        e.minutes = y,
                                                        i.range && (n[r[l]].minutes = y)) : /ss|s/.test(o) && (y < 1 && (y = 0,
                                                            a = !0),
                                                            e.seconds = y,
            ...
            y = y || i.value,
                ...
                n.startState && !n.endState && (delete n.startState,
                    n.endState = !0),
                "string" == typeof y && y ? n.EXP_IF.test(y) ? i.range ? (y = y.split(" " + n.rangeStr + " "),
                    n.startDate = n.startDate || n.systemDate(),
                    n.endDate = n.endDate || n.systemDate(),
                    i.dateTime = lay.extend({}, n.startDate),
                    lay.each([n.startDate, n.endDate], function (e, t) {
                        c(t, y[e], e)
                    })) : c(s, y) : (n.hint(r.formatError[0] + (i.range ? i.format + " " + n.rangeStr + " " + i.format : i.format) + r.formatError[1]),
                        a = !0) : y && "date" === layui._typeof(y) ? i.dateTime = n.systemDate(y) : (i.dateTime = n.systemDate(),
                            ...
                            delete n.endTime,
                            delete n.endState),
                "datetime" !== i.type && "time" !== i.type || n.endTime || (n.endTime = {
                    hours: 23,
                    minutes: 59,
                    seconds: 59
                }),
                ...
                d(s),
                i.range && n.endDate && d(n.endDate),
                a && y && n.setValue(i.range ? n.endDate ? n.parse() : "" : n.parse());
            var u = function (e) {
                return n.newDate(e).getTime()
            };
            return (u(s) > u(i.max) || u(s) < u(i.min)) && (s = i.dateTime = lay.extend({}, i.min)),
                e && e(),
                n
        }
        ,
        ...
        C.prototype.limit = function (e, t, a, n) {
            ...
            return lay.each({
                ...
                i = s.now < s.min || s.now > s.max,
                e && e[i ? "addClass" : "removeClass"](d),
                i
        }
        ,
        C.prototype.calendar = function (e, t) {
            var a, n, i, r = this, s = r.config, o = e ? 1 : 0, d = e || s.dateTime, c = new Date, u = r.lang(), h = "date" !== s.type && "datetime" !== s.type, f = lay(r.table[o]).find("td"), p = lay(r.elemHeader[o][2]).find("span");
            if (d.year < m[0] && (d.year = m[0],
                r.hint(u.invalidDate)),
                d.year > m[1] && (d.year = m[1],
                    r.hint(u.invalidDate)),
                r.firstDate || (r.firstDate = lay.extend({}, d)),
                c.setFullYear(d.year, d.month, 1),
                a = c.getDay(),
                n = l.getEndDate(d.month || 12, d.year),
                i = l.getEndDate(d.month + 1, d.year),
                lay.each(f, function (e, t) {
                    ...
                    t = lay(t),
                        ...
                        e < a ? (o = n - a + e,
                            ...
                            l = r.getAsYM(d.year, d.month, "sub")) : e >= a && e < i + a ? (o = e - a,
                                s.range || o + 1 === d.date && t.addClass(y)) : (o = e - i - a,
                                    t.addClass("laydate-day-next"),
                                    l = r.getAsYM(d.year, d.month)),
                        l[1]++,
                        l[2] = o + 1,
                        t.attr("title", l.join("-")).html(l[2]),
                        r.mark(t, l).limit(t, {
                            year: l[0],
                            month: l[1] - 1,
                            date: l[2]
                ...
                lay(p[0]).attr("lay-ym", d.year + "-" + (d.month + 1)),
                lay(p[1]).attr("lay-ym", d.year + "-" + (d.month + 1)),
                "cn" === s.lang ? (lay(p[0]).attr("lay-type", "year").html(d.year + " \u5e74"),
                    lay(p[1]).attr("lay-type", "month").html(d.month + 1 + " \u6708")) : (lay(p[0]).attr("lay-type", "month").html(u.month[d.month]),
                        lay(p[1]).attr("lay-type", "year").html(d.year)),
                h && (s.range ? (e ? r.endDate = r.endDate || {
                    ...
                    e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]],
                        ...
                        "time" === s.type ? r.setBtnStatus("\u65f6\u95f4", lay.extend({}, r.systemDate(), r.startTime), lay.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))) : (r.listYM = [[d.year, d.month + 1]],
                            r.list(s.type, 0))),
                s.range && !e) {
            ...
            return r.setBtnStatus(),
                s.range && e && !h && r.stampRange(),
                r
        }
        ,
        C.prototype.list = function (e, t) {
            ...
            if (g[0] < 1 && (g[0] = 1),
                ...
                M < 1 && (M = C = 1),
                    lay.each(new Array(15), function (e) {
                        ...
                        C == g[0] && lay(i).addClass(y),
                            i.innerHTML = C + p,
                            s.appendChild(i),
                            C < a.firstDate.year ? (l.month = n.min.month,
                                l.date = n.min.date) : C >= a.firstDate.year && (l.month = n.max.month,
                                    l.date = n.max.date),
                            a.limit(lay(i), l, t),
                            C++
                    }),
                ...
                lay.each(new Array(12), function (e) {
                    ...
                    e + 1 == g[1] && lay(i).addClass(y),
                        i.innerHTML = l.month[e] + (f ? "\u6708" : ""),
                        s.appendChild(i),
                        g[0] < a.firstDate.year ? r.date = n.min.date : g[0] >= a.firstDate.year && (r.date = n.max.date),
                        a.limit(lay(i), r, t)
                }),
                ...
                n.range ? a[D] || (a[D] = "startTime" === D ? i : a.endDate) : a[D] = i,
            ...
            if (h && c.removeChild(h),
                ...
                lay(a.elemMain[t]).addClass("laydate-ym-show"),
                    lay(s).find("li").on("click", function () {
                        var l = 0 | lay(this).attr("lay-ym");
                        if (!lay(this).hasClass(d)) {
                            if (0 === t)
                                i[e] = l,
                                    r && (a.startDate[e] = l),
                                    a.limit(lay(a.footer).find(T), null, 0);
                            else if (r)
                                a.endDate[e] = l;
                            else {
                            ...
                            m ? (lay(s).find("." + y).removeClass(y),
                                lay(this).addClass(y),
                                "month" === n.type && "year" === e && (a.listYM[t][0] = l,
                                    r && (a[["startDate", "endDate"][t]].year = l),
                                    a.list("month", t))) : (a.checkDate("limit").calendar(),
                                        a.closeList()),
                                a.setBtnStatus(),
                                n.range || ("month" === n.type && "month" === e || "year" === n.type && "year" === e) && a.setValue(a.parse()).remove().done(),
                                n.range || a.done(null, "change"),
                                lay(a.footer).find("." + x).removeClass(d)
                        }
                    });
            else {
                var I = lay.elem("span", {
                ...
                S(),
                    ...
                    lay(s).find("ol").each(function (e) {
                        ...
                        lay(t).find("li").on("click", function () {
                            ...
                            lay(this).hasClass(d) || (n.range ? a[D][v[e]] = l : i[v[e]] = l,
        ...
        ,
        C.prototype.listYM = [],
        C.prototype.closeList = function () {
            var e = this;
            e.config;
        ...
        C.prototype.setBtnStatus = function (e, t, a) {
            ...
            l.range || i.limit(s, null, 0, ["hours", "minutes", "seconds"]),
                l.range && "time" !== l.type && (t = t || i.startDate,
                    a = a || i.endDate,
                    n = i.newDate(t).getTime() > i.newDate(a).getTime(),
                    i.limit(null, t) || i.limit(null, a) ? s.addClass(d) : s[n ? "addClass" : "removeClass"](d),
        ...
        C.prototype.stampRange = function (e, t) {
            ...
            if (e) {
                ...
                n.range && !a.endDate && lay(a.footer).find(T).addClass(d);
            ...
            return s && r > s && !e ? a.hint(l.timeout) : void lay.each(i, function (n, i) {
                ...
                if (a.startDate || o === a.newDate(a.systemDate()).getTime() && lay(i).addClass(lay(i).hasClass(g) || lay(i).hasClass(v) ? "" : h),
                    lay(i).removeClass(f + " " + y),
                    o !== r && o !== s || lay(i).addClass(lay(i).hasClass(g) || lay(i).hasClass(v) ? f : y),
                    "mouseenter" === e) {
                    var d = a.newDate({
                        year: t[0],
                        month: t[1] - 1,
        ...
        C.prototype.choose = function (e) {
            var t = this
                ...
                , r = function (e) {
                    new Date;
                    e && lay.extend(n, l),
                        a.range && (t.startDate ? lay.extend(t.startDate, l) : t.startDate = lay.extend({}, l, t.startTime),
                            t.startYMD = l)
                };
            if (l = {
                year: 0 | l[0],
                ...
                if (a.range) {
                    if (lay.each(["startTime", "endTime"], function (e, a) {
                        ...
                        if (e.addClass(y),
                            t.endDate ? lay.extend(t.endDate, l) : t.endDate = lay.extend({}, l, t.endTime),
                            t.newDate(l).getTime() < t.newDate(t.startYMD).getTime()) {
                        ...
                        t.stampRange(),
                            t.endState = !0,
                            t.setValue(t.parse()).remove().done()
                    } else
                        e.addClass(y),
                            i.removeClass(h),
                            r(),
                    ...
                    "static" === a.position ? (r(!0),
                        t.calendar().done().done(null, "change")) : "date" === a.type ? (r(!0),
                            t.setValue(t.parse()).remove().done()) : "datetime" === a.type && (r(!0),
                ...
                , s = function (s) {
                    ...
                    return y && (r[0] = s ? r[0] - 15 : r[0] + 15,
                        ...
                        (y || d) && (lay.extend(n, {
                            ...
                            a.range || t.limit(lay(t.footer).find(T), {
                                year: r[0]
                            })),
                        t.setBtnStatus(),
                        y || d
                    ...
                    lay(a[0]).on("click", function (a) {
                        ...
                        lay(a[2]).find("span").on("click", function (a) {
                            ...
                            i && (i = i.split("-"),
                                ...
                                e.list(l, t),
                                lay(e.footer).find("." + x).addClass(d))
                        }),
        ...
        r.getThis = function (e) {
            var t = r.that[e];
            return !t && a && layui.hint().error(e ? s + " instance with ID '" + e + "' not found" : "ID argument required"),
                t
        }
        ,
        n.run = function (a) {
            a(t).on("mousedown", function (e) {
                ...
                if (l.thisId) {
                    var t = r.getThis(l.thisId);
                    t && 13 === e.keyCode && a("#" + t.elemID)[0] && t.elemID === C.thisElemDate && (e.preventDefault(),
                        a(t.footer).find(T)[0].click())
                }
            }),
                a(e).on("resize", function () {
                    if (l.thisId) {
                        ...
                        if (e)
                            return !(!e.elem || !a(o)[0]) && void e.position()
                    }
                })
        }
        ,
        ...
        link: function (t, i, n) {
            if (r.path) {
                ...
                s.rel = "stylesheet",
                    ...
                    "function" == typeof i && !function u(t) {
                        var n = 100
                            , a = document.getElementById(f);
                        return ++d > 1e4 / n ? e.console && console.error(l + ".css: Invalid") : void (1989 === parseInt(o.getStyle(a, "width")) ? (t === c && a.removeAttribute("lay-status"),
                            a.getAttribute("lay-status") === c ? setTimeout(u, n) : i()) : (a.setAttribute("lay-status", c),
                                setTimeout(function () {
                                    u(c)
                                }, n)))
                    }()
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"],
        ...
        s.pt.vessel = function (e, t) {
            ...
            return r.zIndex = s,
                ...
                }() : "") + (r.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], d, i('<div class="' + l.MOVE + '" id="' + l.MOVE + '"></div>')),
                n
        }
        ,
        s.pt.creat = function () {
            ...
            if (!t.id || !i("#" + t.id)[0]) {
                ...
                if (e.vessel(f, function (n, r, d) {
                    c.append(n[0]),
                        ...
                        i("#" + l.MOVE)[0] || c.append(o.moveElem = d),
                        e.layero = i("#" + l[0] + a),
            ...
            switch (a.type) {
                ...
                default:
                    "" === a.area[1] ? a.maxHeight > 0 && o.outerHeight() > a.maxHeight ? (s[1] = a.maxHeight,
                        d("." + l[5])) : a.fixed && s[1] >= n.height() && (s[1] = n.height(),
                            d("." + l[5])) : d("." + l[5])
            }
            return t
        }
        ...
        s.pt.move = function () {
            ...
            return t.move && f.css("cursor", "move"),
                f.on("mousedown", function (e) {
                    var n = i(this)
                        , a = {};
                    t.move && (a.layero = s,
                        a.config = t,
                        a.offset = [e.clientX - parseFloat(s.css("left")), e.clientY - parseFloat(s.css("top"))],
                        n.data(l[0], a),
                        o.eventMoveElem = n,
                ...
                c.on("mousedown", function (n) {
                    ...
                    t.resize && (r.layero = s,
                        r.config = t,
                        r.offset = [n.clientX, n.clientY],
                        r.index = e.index,
                        r.area = [s.outerWidth(), s.outerHeight()],
                        a.data(l[1], r),
                        o.eventResizeElem = a,
                ...
                o.docEvent ? e : (a.on("mousemove", function (e) {
                    if (o.eventMoveElem) {
                        ...
                        if (e.preventDefault(),
                            t.stX = c ? 0 : n.scrollLeft(),
                            t.stY = c ? 0 : n.scrollTop(),
                            !a.moveOut) {
                    ...
                    if (o.eventMoveElem) {
                        var t = o.eventMoveElem.data(l[0]) || {}
                            , i = t.config;
                        o.eventMoveElem.removeData(l[0]),
                            delete o.eventMoveElem,
                            o.moveElem.hide(),
                            i.moveEnd && i.moveEnd(t.layero)
                    }
                    o.eventResizeElem && (o.eventResizeElem.removeData(l[1]),
                        delete o.eventResizeElem,
                        o.moveElem.hide())
                }),
                    o.docEvent = !0,
                    e)
        ...
        s.pt.callback = function () {
            ...
            t.openLayer(),
                ...
                n.find("." + l[6]).children("a").on("click", function () {
                    var e = i(this).index();
                    if (0 === e)
                        a.yes ? a.yes(t.index, n, t) : a.btn1 ? a.btn1(t.index, n, t) : r.close(t.index);
                    else {
                ...
                n.find(".layui-layer-max").on("click", function () {
                    i(this).hasClass("layui-layer-maxmin") ? (r.restore(t.index),
                        a.restore && a.restore(n, t.index, t)) : (r.full(t.index, a),
                            setTimeout(function () {
        ...
        r.photos = function (t, n, a) {
            ...
            if (t = t || {},
                ...
                s.imgprev = function (e) {
                    s.imgIndex--,
                        s.imgIndex < 1 && (s.imgIndex = d.length),
                        s.tabimg(e)
                }
                    ,
                    s.imgnext = function (e, t) {
                        s.imgIndex++,
                            s.imgIndex > d.length && (s.imgIndex = 1,
                                t) || s.tabimg(e)
                    }
                    ,
                    s.keyup = function (e) {
    ...
    e("component", function (e) {
        ...
        var o = e.MOD_NAME
            ...
            , c = n.extend(!0, {
                ...
                set: function (e) {
                    var t = this;
                    return t.config = n.extend({}, t.config, e),
                        t
                },
                on: function (e, n) {
            ...
            , f = function () {
                ...
                return "function" == typeof e.inst && (r = n.extend(!0, r, e.inst.call(t))),
                    r
            }
            , u = function (e) {
                var t = this;
                t.index = ++c.index,
                    t.config = n.extend({}, t.config, c.config, e),
                    t.init()
            };
        return u.prototype.config = e.config,
            u.prototype.reload = function (e) {
                var t = this;
            ...
            u.prototype.init = function (t) {
                ...
                if (f[0]) {
                    if (f.length > 1)
                        return layui.each(f, function () {
                            c.render(n.extend({}, r, {
                                elem: this
                            }))
                        }),
                            o;
                    r.id = "id" in r ? r.id : o.index,
                        f.attr("lay-options") && (r = o.config = n.extend({}, r, i.options(r.elem[0]))),
                        "function" == typeof e.before && e.before.call(o, o.config),
                        (e.isEventShow && r.show || !e.isEventShow) && o.render(t),
                        f.data(a, r.id),
                        "function" == typeof e.events && o.events()
                }
            }
            ,
            u.prototype.render = e.render,
            u.prototype.events = e.events,
            u.prototype.cache = function (e, n) {
                var t = this
                    , i = t.config
                    , r = i.elem;
                if (r) {
            ...
            ,
            f.that = {},
            f.getThis = c.getThis = function (e) {
                var n = f.that[e];
                return n || t.error(e ? o + " instance with ID '" + e + "' not found" : "ID argument required"),
                    n
            }
            ,
            c.Class = u,
            c.reload = function (e, n) {
                var t = f.that[e];
                return t.reload(n),
                    f.call(t)
            }
    ...
    var t = layui.$
        ...
        , n = {
            fixbar: function (e) {
                ...
                t("." + o)[0] || ("object" == typeof e.css && g.css(e.css),
                    l.append(g),
                    s(),
            ...
            timeAgo: function (e, t) {
                ...
                return o > 26784e5 ? (o = new Date(e),
                    ...
                    n[0].join("-") + " " + n[1].join(":")) : o >= 864e5 ? (o / 1e3 / 60 / 60 / 24 | 0) + "\u5929\u524d" : o >= 36e5 ? (o / 1e3 / 60 / 60 | 0) + "\u5c0f\u65f6\u524d" : o >= 18e4 ? (o / 1e3 / 60 | 0) + "\u5206\u949f\u524d" : o < 0 ? "\u672a\u6765" : "\u521a\u521a"
            },
            digit: function (e, t) {
                var i = "";
                e = String(e),
            ...
            toDateString: function (e, t) {
                ...
                return o.getDate() ? (t = t || "yyyy-MM-dd HH:mm:ss",
                    t.replace(/yyyy/g, r[0]).replace(/MM/g, r[1]).replace(/dd/g, r[2]).replace(/HH/g, a[0]).replace(/mm/g, a[1]).replace(/ss/g, a[2])) : (i.error('Invalid Msec for "util.toDateString(Msec)"'),
                        "")
            },
            escape: function (e) {
                return void 0 !== e && null !== e || (e = ""),
                    String(e).replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;")
            },
            unescape: function (e) {
                return void 0 !== e && null !== e || (e = ""),
                    String(e || "").replace(/\&amp;/g, "&").replace(/\&lt;/g, "<").replace(/\&gt;/g, ">").replace(/\&#39;/, "'").replace(/\&quot;/, '"')
            },
            toVisibleArea: function (e) {
                if (e = t.extend({
                    ...
                    var i = e.scrollElem
                        ...
                        , u = n.offset()[a] - g
                        , s = {};
                    (u > c - e.margin || u < e.margin) && (s[r] = u - c / 2 + l,
            ...
            event: function (e, i, o) {
                var r = t("body");
                return o = o || "click",
                    "object" == typeof e ? e.on(o, function () {
                        var e = t(this)
                            , n = e.attr("lay-event");
                        ...
                        r.off(o, "*[" + e + "]", n.event.UTIL_EVENT_CALLBACK[e]),
                        ...
                        ,
                        r.on(o, "*[" + e + "]", n.event.UTIL_EVENT_CALLBACK[e]),
                        i)
            }
        };
    e("util", n)
...
layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        p.prototype.upload = function (e, i) {
            var n, a = this, r = a.config, l = a.elemFile[0], u = function () {
                ...
                layui.each(o, function (e, o) {
                    ...
                    var c = {
                        ...
                        error: function (t) {
                            n++,
                                a.msg("Request URL is abnormal: " + (t.statusText || "error")),
                                m(e),
                                u()
                        }
                    };
                ...
                a.elemFile.parent().submit(),
                    ...
                    p.timer = setInterval(function () {
                        ...
                        try {
                            ...
                            a.msg("Cross-domain requests are not supported"),
                                clearInterval(p.timer),
                                m()
                        }
                ...
                if (a.elemFile.next("." + s).remove(),
                    ...
                    try {
                        ...
                        return t = {},
                            a.msg("Please return JSON data format")
                    }
                ...
                if (!(("choose" === i || r.auto) && (r.choose && r.choose(g),
                    "choose" === i) || r.before && r.before(g) === !1))
            ...
            if (v = 0 === v.length ? l.value.match(/[^\/\\]+\..+/g) || [] || "" : v,
                0 !== v.length) {
                switch (r.accept) {
                    case "file":
                        layui.each(v, function (e, t) {
                            if (h && !RegExp(".\\.(" + h + ")$", "i").test(escape(t)))
                                return n = !0
                        });
                        break;
                    case "video":
                        layui.each(v, function (e, t) {
                            if (!RegExp(".\\.(" + (h || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(t)))
                                return n = !0
                        });
                        break;
                    case "audio":
                        layui.each(v, function (e, t) {
                            if (!RegExp(".\\.(" + (h || "mp3|wav|mid") + ")$", "i").test(escape(t)))
                                return n = !0
                        });
                        break;
                    default:
                        layui.each(v, function (e, t) {
                            if (!RegExp(".\\.(" + (h || "jpg|png|gif|bmp|jpeg") + ")$", "i").test(escape(t)))
                                return n = !0
                        })
                }
                if (n)
                    return a.msg("\u9009\u62e9\u7684" + F + "\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"),
                        l.value = "";
                if (a.fileLength = function () {
                    ...
                    r.number && a.fileLength > r.number)
                    return a.msg("\u540c\u65f6\u6700\u591a\u53ea\u80fd\u9009\u62e9 " + r.number + " \u4e2a\u6587\u4ef6");
                if (r.size > 0 && !(o.ie && o.ie < 10)) {
                    var b;
                    if (layui.each(a.chooseFiles, function (e, t) {
                        if (t.size > 1024 * r.size) {
                            var i = r.size / 1024;
                            i = i >= 1 ? i.toFixed(2) + "MB" : r.size + "KB",
                                l.value = "",
                                b = i
                        }
                    }),
                        b)
                        return a.msg("\u6587\u4ef6\u5927\u5c0f\u4e0d\u80fd\u8d85\u8fc7 " + b)
                }
                y()
            }
        }
        ...
        p.prototype.events = function () {
            ...
            i.elem.off("upload.start").on("upload.start", function () {
                ...
                o.ie && o.ie < 10 || i.elem.off("upload.over").on("upload.over", function () {
                    ...
                    l.removeAttr("lay-over"),
                        a(u),
                        i.auto ? e.upload(u) : r(u)
                }),
    ...
    var i = layui.$
        ...
        , l = layui.component({
            ...
            render: function (e) {
                var n = this
                    ...
                    , s = function () {
                        ...
                        return r.data.length > 0 ? d(e, r.data) : e.html('<li class="layui-menu-item-none">no menu</li>'),
                            e
                    }
                    , d = function (e, n) {
                            ...
                            if ("-" === s || a.title || a.id || o) {
                                ...
                                if (T.data("item", a),
                                    ...
                                    var c = i('<div class="layui-panel layui-menu-body-panel"></div>')
                                        , p = i("<ul></ul>");
                                    "parent" === s ? (c.append(d(p, a.child)),
                                        T.append(c)) : T.append(d(p, a.child))
                                }
                                e.append(T)
                            }
                        }),
                ...
                ("contextmenu" === r.trigger || lay.isTopElem(r.elem[0])) && (e = !0),
                    n.elemView = i(T),
                    n.elemView.append(r.content || s()),
                    r.className && n.elemView.addClass(r.className),
                    r.style && n.elemView.attr("style", r.style),
                    r.component && n.elemView.attr("lay-component", r.component),
                    l.thisId = r.id,
                    n.remove(),
                    m.append(n.elemView),
                    r.elem.data(l.CONST.MOD_INDEX + "_opened", !0),
                    n.position(),
                    o.prevElem = n.elemView,
                    o.prevElem.data("prevElem", r.elem),
                    n.elemView.find(".layui-menu").on(a, function (e) {
                        layui.stope(e)
                    }),
                    n.elemView.find(".layui-menu li").on("click", function (e) {
                        ...
                        return l || "-" === a.type || (n.remove(),
                            "function" == typeof r.click && r.click(a, t)),
                            "function" == typeof r.clickItem && r.clickItem(a, t),
                            !1
                    }),
            ...
            events: function () {
                var e = this
                    , i = e.config;
                i.elem.off(i.trigger, i.elem.data(l.CONST.TRIGGER_NAME)),
                    i.elem.data(l.CONST.TRIGGER_NAME, function (t) {
                        if (clearTimeout(o.timer),
                            e.e = t,
                            t.preventDefault(),
                            i.elem.data(l.CONST.MOD_INDEX + "_opened")) {
                        ...
                        e.render(),
                            "function" == typeof i.ready && i.ready(e.elemView, i.elem, t.target)
                    }),
                    i.elem.on(i.trigger, i.elem.data(l.CONST.TRIGGER_NAME)),
    ...
    r.prototype.position = function (e) {
        ...
        r.prototype.remove = function () {
            var e = this
                , i = e.config
                , t = o.prevElem;
            t && (t.data("prevElem") && t.data("prevElem").data(l.CONST.MOD_INDEX + "_opened", !1),
                t.remove(),
        ...
        o.spread = function (e) {
            ...
            e.hasClass(l.CONST.STR_ITEM_UP) ? (e.removeClass(l.CONST.STR_ITEM_UP).addClass(l.CONST.STR_ITEM_DOWN),
                i.removeClass("layui-icon-down").addClass("layui-icon-up")) : (e.removeClass(l.CONST.STR_ITEM_DOWN).addClass(l.CONST.STR_ITEM_UP),
        ...
        !function () {
            ...
            e.on("resize", function () {
                if (l.thisId) {
                    ...
                    if (e) {
                        if (!e.elemView || !e.elemView[0] || !i("." + l.CONST.STR_ELEM)[0])
                            return !1;
                        var t = e.config;
            ...
            t.on("click", n, function (e) {
                var t = i(this)
                    ...
                    , r = lay.options(this);
                t.hasClass(l.CONST.STR_ITEM_DIV) || a || (n.find("." + l.CONST.STR_ITEM_CHECKED).removeClass(l.CONST.STR_ITEM_CHECKED),
                    n.find("." + l.CONST.STR_ITEM_CHECKED2).removeClass(l.CONST.STR_ITEM_CHECKED2),
                    t.addClass(l.CONST.STR_ITEM_CHECKED),
                    t.parents("." + l.CONST.STR_ITEM_PARENT).addClass(l.CONST.STR_ITEM_CHECKED2),
                    layui.event.call(this, l.CONST.MOD_NAME, "click(" + o + ")", r))
            }),
            ...
            t.on("mouseenter", r, function (t) {
                ...
                if (a[0]) {
                    ...
                    o.right > e.width() && (a.addClass(l.CONST.STR_MENU_PANEL_L),
                        o = a[0].getBoundingClientRect(),
                        o.left < 0 && a.removeClass(l.CONST.STR_MENU_PANEL_L)),
                        o.bottom > e.height() && a.eq(0).css("margin-top", -(o.bottom - e.height()))
                }
            }).on("mouseleave", r, function (e) {
                var t = i(this)
                    , n = t.children("." + l.CONST.STR_MENU_PANEL);
                n.removeClass(l.CONST.STR_MENU_PANEL_L),
                    n.css("margin-top", 0)
            })
        }(),
...
layui.define(["jquery", "lay"], function (e) {
    ...
    F.prototype.config = {
        ...
        F.prototype.removePicker = function (e) {
            ...
            return n[0] && (n.remove(),
                "function" == typeof o.close && o.close(r)),
                r
        }
        ,
...
layui.define("layer", function (e) {
                ...
                , f = {
                    input: function () {
                        ...
                        u.autocomplete && e.attr("autocomplete", u.autocomplete),
                            d.find("input[lay-affix],textarea[lay-affix]").each(function () {
                                var e = t(this)
                                    , i = e.attr("lay-affix")
                                    ...
                                    , o = function (a) {
                                        n.remove(),
                                            n = t(['<div class="layui-input-suffix layui-input-affix-event">', '<i class="layui-icon layui-icon-' + a + '"></i>', "</div>"].join("")),
                                            e.after(n),
                                            r(n, e.val()),
                                            ...
                                            n.on("click", function () {
                                                ...
                                                c[i] && c[i][1].call(this),
                                                    layui.event.call(this, l, "input-affix(" + t + ")", {
                                                        elem: e[0],
                                                        affix: i
                                                    })
                                            })
                                        ...
                                        eye: [function () {
                                            ...
                                            , function () {
                                                var t = "LAY_FORM_INPUT_AFFIX_SHOW"
                                                    , i = e.data(t);
                                                e.attr("type", i ? "password" : "text").data(t, !i),
                                                    o(i ? "eye" : "eye-invisible")
                                            }
                                        ]
                                    };
                                c[i] && c[i][0]()
                    ...
                    select: function () {
                        var e, i = "\u8bf7\u9009\u62e9", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", u = "", f = d.find("select"), v = function (i, l) {
                            ...
                            var y, p = t(this), m = i.find("." + n), x = m.find("input"), g = i.find("dl"), k = g.children("dd"), b = this.selectedIndex;
                            if (!d) {
                                var C = function () {
                                    ...
                                    b = p[0].selectedIndex,
                                        ...
                                        k.removeClass(s),
                                        y = null,
                                        k.eq(b).addClass(o).siblings().removeClass(o),
                                ...
                                f && x.on("keyup", F).on("blur", function (i) {
                                    ...
                                    k.on("click", function () {
                                        var e = t(this)
                                            , a = e.attr("lay-value")
                                            , n = p.attr("lay-filter");
                                        return !e.hasClass(c) && (e.hasClass("layui-select-tips") ? x.val("") : (x.val(e.text()),
                                            e.addClass(o)),
    ...
    var d = u.prototype.submit = function (e, a) {
            ...
            if (l.removeClass(y),
                layui.each(r, function (e, t) {
                    ...
                    if (h[t]) {
                        ...
                        if (c = c || h[t][1],
                            "required" === t && (c = l.attr("lay-reqText") || c),
                            r)
                            return "tips" === o ? i.tips(c, function () {
        ...
        return "function" == typeof a && a(m),
            layui.event.call(this, l, "submit(" + s + ")", m)
    }
        , f = new u
        , v = t(document)
        , h = t(window);
...
layui.define(["laypage", "component", "dropdown", "form", "util"], function (i) {
    ...
    var e = layui.$
        ...
        , o = layui.component({
            ...
            before: function (i) {
                var e = this
                    , l = i.elem;
                i.data = "array" === layui._typeof(i.data) ? i.data : e.data,
                    i.value = l.val() || i.value,
                    i.title = l.attr("title") || i.title,
                    i.placeholder = l.attr("placeholder") || i.placeholder
            },
            render: function (i) {
                var l = this
                    , n = l.config
                    ...
                    , s = l.elemReview = e(['<div class="layui-inline layui-border-box ' + o.CONST.elem + (n.isSplit ? " " + o.CONST.split : "") + '">', function () {
                        var i = [];
                        return !n.value || n.replace !== !0 && "icon" !== n.replace || i.push('<i class="layui-inline ' + n.fontfamily + " " + ("fontclass" === n.type ? n.value : "") + '">' + ("unicode" === n.type ? n.value : "") + "</i>"),
                            !n.title || n.replace !== !0 && "title" !== n.replace || i.push('<span class="layui-inline layui-iconpicker-title">' + n.title + "</span>"),
                            n.value || n.title || !n.placeholder || i.push('<span class="layui-inline layui-iconpicker-none">' + n.placeholder + "</span>"),
                            i.length > 0 && (i.unshift('<div class="layui-inline layui-iconpicker-main">'),
                                i.push("</div>")),
                            i.join("")
                    }(), '<span class="layui-inline layui-iconpicker-suffix">', '<i class="layui-icon layui-icon-down layui-anim"></i>', "</span>", "</div>"].join(""));
                n.replace ? (a.next().hasClass(o.CONST.elem) && a.next().remove(),
                    a.addClass(o.CONST.CLASS_HIDE).after(s),
                    n.className && s.addClass(n.className),
                    n.style && s.attr("style", n.style)) : s = a,
                    l.elemView = e('<div class="layui-iconpicker-view"></div>'),
                    l.elemViewSearch = e(['<div class="' + o.CONST.search + '">', '<div class="' + o.CONST.wrap + '" lay-filter="LAY-ICON-FORM-DF-' + n.id + '">', '<div class="layui-input-prefix">', '<i class="layui-icon layui-icon-search"></i>', "</div>", '<input type="text" value="' + (l.cache("search") || "") + '" placeholder="search" autocomplete="off" class="layui-input" lay-filter="LAY-ICON-INPUT-' + n.id + '" lay-affix="clear">', "</div>", "</div>"].join("")),
                    l.elemViewList = e('<div class="' + o.CONST.list + '"></div>'),
                    l.elemViewPage = e('<div class="' + o.CONST.page + '" id="LAY-ICON-PAGE-' + n.id + '"></div>'),
                    n.search && l.elemView.append(l.elemViewSearch),
                    l.elemView.append(l.elemViewList),
                    n.page ? l.elemView.append(l.elemViewPage) : l.elemView.addClass(o.CONST.scroll),
                    l.renderData(),
                    t.render(e.extend({}, n, {
                        elem: s,
                        content: l.elemView,
                        ...
                        ready: function (i) {
                            ...
                            c.render("input", e),
                                l.events(i),
                                s.addClass(o.CONST.down),
                                "function" == typeof n.ready && n.ready(l.elemView, n.elem)
                        },
                        close: function () {
                            s.removeClass(o.CONST.down),
            ...
            exports: {
                close: function (i) {
                    var e = o.getThis(i);
                    return e ? (t.close(o.CONST.MOD_NAME_UPPER + "_" + i),
                        e) : this
                }
            }
        })
    ...
    a.prototype.renderIcon = function (i) {
        ...
        i = e.thisData = i || l.data || [],
            ...
            i.length > 0 ? t.push("</ul>") : t = ['<div class="layui-none">\u672a\u5339\u914d\u5230\u56fe\u6807</div>'],
            e.elemViewList.html(t.join(""))
    }
        ,
        a.prototype.search = function (i) {
            var e = this
                ...
                , t = [];
            i = (i || "").toLowerCase(),
                layui.each(l.data, function (e, c) {
                    try {
        ...
        a.prototype.events = function (i) {
            ...
            i.find("." + o.CONST.list).on("click", "li", function () {
                var i = e(this)
                    , c = i.index()
                    , a = l.thisData[c] || {};
                i.addClass(o.CONST.CLASS_THIS),
                    t.elem.val(n.escape(a[t.type])).attr("title", a.title),
                    o.reload(t.id),
                    "function" == typeof t.click && t.click(a),
                    o.close(t.id)
            }),
                t.search && (a.on("input propertychange", function () {
                    l.search(this.value)
                }),
                    l.cache("search") && l.search(l.cache("search")),
                    c.on("input-affix(" + s + ")", function (i) {
                        "clear" === i.affix && (l.renderData(),
                            l.cache("search", null))
                    }))
        }
        ,
...
layui.define(["laypage", "component", "dropdown", "form", "util"], function (t) {
        ...
        , n = layui.component({
            ...
            render: function (t) {
                var a = this
                    , c = a.config;
                c.elem;
                a.elemView = e('<div class="' + n.CONST.elem + ' layui-unselect"></div>'),
                    a.elemViewHeader = e(['<div class="' + n.CONST.header + '">', '<button type="button" class="' + n.CONST.headerBtn + '" lay-event="clear">\u6e05\u7a7a</button>', "<span>" + c.title + "</span>", '<button type="button" class="' + n.CONST.headerBtn + '" lay-event="confirm">\u786e\u8ba4</button>', "</div>"].join("")),
                    a.elemViewList = e('<div class="' + n.CONST.list + '"></div>'),
                    c.isHeader && a.elemView.append(a.elemViewHeader),
                    a.elemView.append(a.elemViewList);
                ...
                lay.style({
                    ...
                    l.render(e.extend({}, c, {
                        ...
                        ready: function (t) {
                            ...
                            i.render("input", e),
                                a.events(t),
                                "function" == typeof c.ready && c.ready(a.elemView, c.elem)
                        },
                        close: function () {
            ...
            exports: {
                close: function (t) {
                    var e = n.getThis(t);
                    return e ? (l.close(n.CONST.MOD_NAME_UPPER + "_" + t),
                        e) : this
                }
            }
        })
    ...
    c.prototype.getValue = function (t) {
        return t = t || {},
            t.value = "value" in t ? t.value : t.title
    }
        ,
        ...
        c.prototype.renderData = function (t) {
            ...
            t = t || i.data || [],
                layui.each(t, function (t, l) {
                    l = l || {},
                        l.type && o[l.type] && (l = e.extend({}, o[l.type], l)),
                        "br" === l.type ? a.push("<br>") : a.push("<li" + function () {
                            var t = [];
                            return l.selected && t.push(n.CONST.CLASS_THIS),
                                l.disabled && t.push(n.CONST.CLASS_DISABLED),
                                l.hide && t.push(n.CONST.CLASS_HIDE),
                                t.length > 0 ? ' class="' + t.join(" ") + '"' : ""
                        }() + (l.style ? ' style="' + l.style + '"' : "") + ' data-index="' + t + '">' + (l.title || "") + "</li>")
                }),
                t.length > 0 ? a.push("</ul>") : a = ['<div class="layui-none">none</div>'],
                l.elemViewList.html(a.join(""))
        }
        ,
        c.prototype.events = function (t) {
            ...
            t.find("." + n.CONST.list).on("click", "li", function () {
                var t = e(this)
                    ...
                    , u = function (t) {
                        t = t || y,
                            i.single ? i.elem.val(t) : lay(i.elem[0]).insertVal(t)
                    }
                    , d = e.extend({
                        keyData: c,
                        keyElem: t,
                ...
                t.hasClass(n.CONST.CLASS_DISABLED) || (r ? o[r] && ("function" == typeof o[r].click ? o[r].click(d) : u()) : u(),
                    "function" == typeof i.click && i.click(d))
            }),
                a.event(c.find("." + n.CONST.btn), {
                    clear: function () {
                        i.elem.val(""),
                            s.value = i.elem.val(),
                            "function" == typeof i.clear && i.clear(s)
                    },
                    confirm: function () {
                        s.value = i.elem.val(),
                            "function" == typeof i.done && i.done(s),
                            n.close(i.id)
                    }
                })
        }
    ...
    var o = c.prototype.fnKey = {
        ...
        decimal: {
            ...
            click: function (t) {
                ...
                if ("number" === e.type) {
                    if (!i)
                        return t.setValue("0" + a.value);
                    if (i.indexOf(a.value) !== -1)
                        return
                }
                t.setValue()
            }
        ...
        caps: {
            ...
            selectedCall: function (t, e) {
                ...
                layui.each(e.data, function (t, e) {
                    e.type || (e.title && (e.title = e.title[l]()),
...
layui.define(["lay", "laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$
        ...
        , c = {
            ...
            set: function (e) {
                var a = this;
                return a.config = t.extend({}, a.config, e),
                    a
            },
            on: function (e, t) {
        ...
        , D = function (e) {
            var a = this;
            a.index = ++c.index,
                a.config = t.extend({}, a.config, c.config, e),
                a.render()
        };
    D.prototype.config = {
        limit: 10,
        ...
        D.prototype.render = function (e) {
            ...
            if (l.elem = t(l.elem),
                l.where = l.where || {},
                l.id = l.id || l.elem.attr("id") || i.index,
                l.request = t.extend({
                    pageName: "page",
                    limitName: "limit"
                }, l.request),
                ...
                "object" == typeof l.page && (l.limit = l.page.limit || l.limit,
                    l.limits = l.page.limits || l.limits,
                    i.page = l.page.curr = l.page.curr || 1,
                    delete l.page.elem,
                    delete l.page.jump),
                !l.elem[0])
                return i;
            l.height && /^full-\d+$/.test(l.height) && (i.fullHeightGap = l.height.split("-")[1],
                l.height = I.height() - i.fullHeightGap),
                i.setInit(),
                a.config({
                    open: "{{",
                    close: "}}"
            ...
            if (l.index = i.index,
                i.key = l.id || l.index,
                "reloadData" === e)
                return i.pullData(i.page);
            if (o[0] && o.remove(),
                n.after(r),
                i.layTool = r.find(b),
                i.layBox = r.find(x),
                i.layHeader = r.find(C),
                i.layMain = r.find(T),
                i.layBody = r.find(w),
                i.layFixed = r.find(N),
                i.layFixLeft = r.find(L),
                i.layFixRight = r.find(_),
                i.layTotal = r.find(S),
                i.layPage = r.find(A),
                i.renderToolbar(),
                i.renderPagebar(),
        ...
        D.prototype.setInit = function (e) {
            ...
            layui.each(a.cols, function (e, i) {
                layui.each(i, function (l, n) {
                    if (!n)
                        return void i.splice(l, 1);
                    if (n.key = e + "-" + l,
                        n.hide = n.hide || !1,
                        n.colGroup || n.colspan > 1) {
                        var o = 0;
                        layui.each(a.cols[e + 1], function (t, a) {
                            a.HAS_PARENT || o > 1 && o == n.colspan || (a.HAS_PARENT = !0,
                                a.parentKey = e + "-" + l,
                                o += parseInt(a.colspan > 1 ? a.colspan : 1))
                        }),
                            n.colGroup = !0
                    }
                    t.initOpts(n)
            ...
            var r = function (e) {
                layui.each(t.cols, function (a, r) {
                    layui.each(r, function (a, d) {
                        ...
                        return d ? void (d.colGroup || d.hide || (e ? l && l < s && (i--,
                            c = s) : (c = d.width || 0,
                                /\d+%$/.test(c) ? (c = Math.floor(parseFloat(c) / 100 * o),
                                    c < s && (c = s)) : c || (d.width = c = 0,
                                        i++)),
                            d.hide && (c = 0),
                            n += c)) : void r.splice(a, 1)
                    })
                }),
                    o > n && i && (l = (o - n) / i)
            };
            ...
            if (e.autoColNums && d >= -a && d <= a) {
                var c = function (t) {
                    ...
                    return t = t || e.layHeader.eq(0).find("thead th:last-child"),
                        a = t.data("field"),
                        !a && t.prev()[0] ? c(t.prev()) : t
                }
                    , s = c()
                    , u = s.data("key");
                e.getCssRule(u, function (t) {
                    var a = t.style.width || s.outerWidth();
                    t.style.width = parseFloat(a) + d + "px",
        ...
        D.prototype.reload = function (e, a, i) {
            ...
            e = e || {},
                ...
                l.config = t.extend(a, {}, l.config, e),
                l.render(i)
        }
        ,
        D.prototype.errorView = function (e) {
            ...
            i[0] && (a.layNone.remove(),
                i.remove()),
                a.layFixed.addClass(p),
                a.layMain.find("tbody").html(""),
                a.layMain.append(a.layNone = l),
                c.cache[a.key] = []
        }
        ,
        D.prototype.page = 1,
        D.prototype.pullData = function (e) {
            var a = this
                , i = a.config
                , l = i.request
                , n = i.response
            ...
            if (a.startTime = (new Date).getTime(),
                ...
                var r = {};
                r[l.pageName] = e,
                    r[l.limitName] = i.limit;
                var d = t.extend(r, i.where);
                i.contentType && 0 == i.contentType.indexOf("application/json") && (d = JSON.stringify(d)),
                    a.loading(),
                    t.ajax({
                        type: i.method || "get",
                        url: i.url,
                        ...
                        success: function (t) {
                            "function" == typeof i.parseData && (t = i.parseData(t) || t),
                                t[n.statusName] != n.statusCode ? (a.renderForm(),
                                    a.errorView(t[n.msgName] || '\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"' + n.statusName + '": ' + n.statusCode)) : (a.renderData(t, e, t[n.countName]),
                                        o(),
                                        i.time = (new Date).getTime() - a.startTime + " ms"),
                                a.setColsWidth(),
                                "function" == typeof i.done && i.done(t, e, t[n.countName])
                        },
                        error: function (e, t) {
                            a.errorView("\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a" + t),
                                a.renderForm(),
                                a.setColsWidth(),
                ...
                var c = {}
                    , s = e * i.limit - i.limit;
                c[n.dataName] = i.data.concat().splice(s, i.limit),
                    c[n.countName] = i.data.length,
                    "object" == typeof i.totalRow && (c[n.totalRowName] = t.extend({}, i.totalRow)),
                    a.renderData(c, e, c[n.countName]),
                    o(),
                    a.setColsWidth(),
                    "function" == typeof i.done && i.done(c, e, c[n.countName])
            }
        }
        ,
        ...
        D.prototype.renderData = function (e, n, o, r) {
            var d = this
                ...
                , x = function () {
                    ...
                    return !r && d.sortKey ? d.sort(d.sortKey.field, d.sortKey.sort, !0) : (layui.each(u, function (i, l) {
                        ...
                        "array" === layui._typeof(l) && 0 === l.length || (r || (l[c.config.indexName] = i),
                            d.eachCols(function (n, r) {
                                ...
                                if (void 0 !== g && null !== g || (g = ""),
                                    ...
                                    o.push(b),
                                        r.fixed && "right" !== r.fixed && h.push(b),
                                        "right" === r.fixed && v.push(b)
                                }
                            }),
                            f.push('<tr data-index="' + i + '">' + o.join("") + "</tr>"),
                            g.push('<tr data-index="' + i + '">' + h.join("") + "</tr>"),
                            b.push('<tr data-index="' + i + '">' + v.join("") + "</tr>"))
                    }),
                        d.layBody.scrollTop(0),
                        d.layMain.find("." + m).remove(),
                        d.layMain.find("tbody").html(f.join("")),
                        d.layFixLeft.find("tbody").html(g.join("")),
                        d.layFixRight.find("tbody").html(b.join("")),
                        d.renderForm(),
            ...
            return c.cache[d.key] = u,
                d.layTotal[0 == u.length ? "addClass" : "removeClass"](v),
                s.pagebar || d.layPage[0 == o || 0 === u.length && 1 == n ? "addClass" : "removeClass"](v),
                ...
                l.eachCols(function (e, d) {
                    var c = d.field || e
                        , s = function () {
                            ...
                            return n[c] = a,
                                e = d.totalRow ? y.call(l, d, a, n) || t : t,
                                i ? i[d.field] || e : e
                        }()
        ...
        D.prototype.sort = function (e, a, i, l) {
            ...
            "string" == typeof e && (n = e,
                d.layHeader.find("th").each(function (a, i) {
                    var l = t(this)
                        , o = l.data("field");
                    if (o === e)
                        return e = l,
            ...
            try {
                ...
                d.layHeader.find("th").find(R).removeAttr("lay-sort"),
                    v.attr("lay-sort", a || null),
                    d.layFixed.find("th")
            } catch (m) {
            ...
            d.sortKey = {
                ...
                u.autoSort && ("asc" === a ? o = layui.sort(f, n) : "desc" === a ? o = layui.sort(f, n, !0) : (o = layui.sort(f, c.config.indexName),
                    delete d.sortKey)),
        ...
        D.prototype.loading = function (e) {
            var a = this
                , i = a.config;
            i.loading && (e ? (a.layInit && a.layInit.remove(),
                delete a.layInit,
                a.layBox.find(k).remove()) : (a.layInit = t(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>', "</div>"].join("")),
                    a.layBox.append(a.layInit)))
        }
        ,
        ...
        D.prototype.syncCheckAll = function () {
            ...
            a[0] && (c.checkStatus(e.key).isAll ? (a[0].checked || (a.prop("checked", !0),
                e.renderForm("checkbox")),
                i(!0)) : (a[0].checked && (a.prop("checked", !1),
                    e.renderForm("checkbox")),
                    i(!1)))
        }
        ,
        D.prototype.getCssRule = function (e, t) {
            ...
            layui.each(n, function (a, i) {
                if (i.selectorText === ".laytable-cell-" + e)
                    return t(i),
                        !0
            })
        }
        ...
        D.prototype.fullSize = function () {
            ...
            t.fullHeightGap && (i = I.height() - t.fullHeightGap,
                i < 135 && (i = 135),
                t.elem.css("height", i)),
                i && (e = parseFloat(i) - (t.layHeader.outerHeight() || 38),
                    a.toolbar && (e -= t.layTool.outerHeight() || 50),
                    a.totalRow && (e -= t.layTotal.outerHeight() || 40),
                    a.page && (e -= t.layPage.outerHeight() || 41),
        ...
        D.prototype.scrollPatch = function () {
            ...
            var r = e.layMain.height()
                , d = r - l;
            e.layFixed.find(w).css("height", a.height() >= d ? d : "auto"),
                e.layFixRight[n > 0 ? "removeClass" : "addClass"](p),
                e.layFixRight.css("right", i - 1)
        }
        ,
        D.prototype.events = function () {
            var e, a = this, i = a.config, o = t("body"), r = {}, s = a.layHeader.find("th"), u = ".layui-table-cell", f = i.elem.attr("lay-filter");
            a.layTool.on("click", "*[lay-event]", function (e) {
                var o = t(this)
                    ...
                    , s = function (e) {
                        ...
                        n.html(l),
                            i.height && n.css("max-height", i.height - (a.layTool.outerHeight() || 50)),
                                    ...
                                    layui.each(i.cols, function (e, t) {
                                        layui.each(t, function (t, l) {
                                            if (e + "-" + t === o) {
                                                var d = l.hide;
                                                l.hide = !n,
                                                    a.elem.find('*[data-key="' + i.index + "-" + o + '"]')[n ? "removeClass" : "addClass"](p),
                                                    d != l.hide && a.setParentCol(!n, r),
                                                    a.resize()
                                            }
                                        })
                                    })
                ...
                s.on("mousemove", function (e) {
                    var a = t(this)
                        , i = a.offset().left
                        , l = e.clientX - i;
                    a.data("unresize") || r.resizeStart || (r.allowResize = a.width() - l <= 10,
                    ...
                    if (r.allowResize) {
                        ...
                        e.preventDefault(),
                            ...
                            a.getCssRule(n, function (e) {
                                var t = e.style.width || l.outerWidth();
                                r.rule = e,
                                    r.ruleWidth = parseFloat(t),
                                    r.minWidth = l.data("minwidth") || i.cellMinWidth
                            })
                    }
                }),
            ...
            a.layBody.on("change", "." + W, function () {
                ...
                var e, i = t(this), l = this, n = i.parent().data("field"), o = i.parents("tr").eq(0).data("index"), r = c.cache[a.key][o];
                a.eachCols(function (t, a) {
                ...
                a.layBody.on("click", "td", function (e) {
                    ...
                    if (!a.data("off") && i) {
                        ...
                        return n[0].value = a.data("content") || l.text(),
                            a.find("." + W)[0] || a.append(n),
                            n.focus(),
                            void layui.stope(e)
                    }
            ...
            var g = "layui-table-grid-down"
                , b = function (e) {
                    ...
                    if (!a.data("off"))
                        if (e)
                            a.find(".layui-table-grid-down").remove();
        ...
        s.that = {},
        s.config = {},
        c.eachCols = function (e, a, i) {
            var l = s.config[e] || {}
                , n = []
                , o = 0;
            i = t.extend(!0, [], i || l.cols),
                layui.each(i, function (e, t) {
                        ...
                        if (a.colGroup) {
                            ...
                            o++,
                                ...
                                layui.each(i[e + 1], function (e, t) {
                                    t.PARENT_COL_INDEX || l > 1 && l == a.colspan || (t.PARENT_COL_INDEX = o,
                                        a.CHILD_COLS.push(t),
        ...
        c.checkStatus = function (e) {
            ...
            return layui.each(l, function (e, l) {
                return "array" === layui._typeof(l) ? void a++ : void (l[c.config.checkName] && (t++,
                    i.push(c.clearCacheKey(l))))
            }),
            {
                data: i,
        ...
        c.exportFile = function (e, t, a) {
            ...
            return d.ie ? r.error("IE_NOT_SUPPORT_EXPORTS") : (u.href = "data:" + o + ";charset=utf-8,\ufeff" + encodeURIComponent(function () {
                ...
                u.download = (n.title || "table_" + (n.index || "")) + "." + a,
...
layui.define("jquery", function (e) {
    ...
    var n = layui.$
            ...
            layui.device(),
        {
            ...
            set: function (e) {
                var i = this;
                return i.config = n.extend({}, i.config, e),
                    i
            },
            on: function (e, n) {
        ...
        , m = function (e) {
            var t = this;
            t.config = n.extend({}, t.config, i.config, e),
                t.render()
        };
    m.prototype.config = {
        width: "600px",
        ...
        m.prototype.render = function () {
            var e = this
                , i = e.config;
            i.elem = n(i.elem),
                i.elem[0] && (e.elemItem = i.elem.find(l),
                    i.index < 0 && (i.index = 0),
                    ...
                    e.elemItem.eq(i.index).addClass(a),
        ...
        m.prototype.prevIndex = function () {
            var e = this
                , n = e.config
                , i = n.index - 1;
            return i < 0 && (i = e.elemItem.length - 1),
                i
        }
        ,
        m.prototype.nextIndex = function () {
            var e = this
                , n = e.config
                , i = n.index + 1;
            return i >= e.elemItem.length && (i = 0),
                i
        }
        ,
        m.prototype.addIndex = function (e) {
            ...
            e = e || 1,
                i.index = i.index + e,
                i.index >= n.elemItem.length && (i.index = 0)
        }
        ,
        m.prototype.subIndex = function (e) {
            ...
            e = e || 1,
                i.index = i.index - e,
                i.index < 0 && (i.index = n.elemItem.length - 1)
        }
        ,
        ...
        m.prototype.arrow = function () {
            ...
            i.elem.attr("lay-arrow", i.arrow),
                i.elem.find("." + u)[0] && i.elem.find("." + u).remove(),
                i.elem.append(t),
                t.on("click", function () {
                    var i = n(this)
                        , t = i.attr("lay-type");
        ...
        m.prototype.indicator = function () {
            ...
            i.elem.attr("lay-indicator", i.indicator),
                i.elem.find("." + c)[0] && i.elem.find("." + c).remove(),
                i.elem.append(t),
                "updown" === i.anim && t.css("margin-top", -(t.height() / 2)),
                t.find("li").on("hover" === i.trigger ? "mouseover" : i.trigger, function () {
                    var t = n(this)
                        , a = t.index();
        ...
        m.prototype.slide = function (e, n) {
            ...
            if (!i.haveSlide) {
                "sub" === e ? (i.subIndex(n),
                    ...
                    i.elemInd.find("li").eq(u.index).addClass(a).siblings().removeClass(a),
                    i.haveSlide = !0;
                var f = {
                    index: u.index,
                    prevIndex: c,
                ...
                "function" == typeof u.change && u.change(f),
                    layui.event.call(this, t, "change(" + m + ")", f)
            }
        }
        ,
...
layui.define(["layer", "form"], function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        s.prototype.build = function (t, i) {
            ...
            return l.ie && l.ie < 8 ? s.removeClass("layui-hide").addClass(o) : (d[0] && d.remove(),
                c.call(a, m, s[0], y),
