...
public class ConsoleTable
{
    ...
    {
        ConsoleExtend.WriteColorLine(GetHeader(), color);
        ConsoleExtend.WriteInfoLine(GetExistData());
        ConsoleExtend.WriteColorLine(GetEnd(), color);
    }
    ...
    private static string GetColumnValue<T>(T obj, string column)
    {
        ...
        JObject o = obj as JObject ?? obj.ObjToJson().JsonToObj<JObject>();
